...
<section class="section">
	<div class="section-header">
		...
		<div class="section-header-breadcrumb">
			<button class="btn btn-success" id="modal-5" onclick="show_modal()">Tambah User</button>
		</div>
	</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xZeroxSugarx\xampp\htdocs\kalender-edu\application\views/private/user/index.blade.php ENDPATH**/ ?>