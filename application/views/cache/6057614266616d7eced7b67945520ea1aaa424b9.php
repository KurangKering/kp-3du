 	...
 	<div class="container-fluid">
 		<div class="animated fadeIn">
 			<form  class="form-horizontal" id="form-peminjaman" autocomplete="off">
 				...
 				<input type="hidden" name="pengajuan_inventaris_id" value="<?php echo e($dataPengajuan->id); ?>">
 									...
 									<div class="col-md-8">
 										...
 										<div class="input-group-date">
 											<select name="addNamaInventaris" id="addNamaInventaris" class="form-control">
 												...
 												<option data-satuan="<?php echo e($inventaris->satuan); ?>"  value="<?php echo e($inventaris->id); ?>"><?php echo e($inventaris->nama); ?></option>
 ...
 <script>
 	...
 	echo "var arrInventaris = " . $jsArrRequested . ";\n";
 	?>
 	...
 	const a = generateInventaris({
 		...
 		submitData : function(e)
 		{
 			...
 			var URL = SITE_URL + 'private/pengajuan_inventaris/update';
 			$.ajax({
 				url: URL,
 				type: 'POST',
 				dataType: 'json',
 ...
 <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xZeroxSugarx\xampp\htdocs\kp-edu\application\views/private/pengajuan_inventaris/edit.blade.php ENDPATH**/ ?>