            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <div class="col-md-12">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody id="tbody-isi-disposisi">
                                            ...
                                            @foreach ($peminjamanRuangan->lembar_disposisi->isi_disposisi as $isi)
                                                <tr>
                                                    <td style="width: 20%;">
                                                        {{ $allRole->where('id', $isi->from_role_id)->first()->role_name }}
                                                    </td>
                                                    <td style="width: 20%;">
                                                        {{ $allRole->where('id', $isi->destination_role_id)->first()->role_name }}
                                                    </td>
                                ...
                                <form method="POST" id="frm-terima" class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="input-group-date">
                                                <input class="form-control date" id="" type="text" name=""
                                                    value="{{ $peminjamanRuangan->nama }}" onkeydown="return false">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="input-group-date">
                                                <input class="form-control date" id="" type="text" name=""
                                                    value="{{ $peminjamanRuangan->kegiatan }}" onkeydown="return false">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <select class="form-control" name="inputRuangan" id="inputRuangan">
                                                @foreach ($dataRuangan as $ruangan)
                                                    <option
                                                        {{ $ruangan->id == $peminjamanRuangan->ruangan_id ? 'selected' : '' }}
                                    ...
                                    <div class="form-group row" id="data_1">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group-date">
                                                <input onkeydown="return false" class="form-control date" id="inputTanggal"
                                                    type="text" name="inputTanggal"
                                                    value="{{ $peminjamanRuangan->tanggal }}">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group clockpicker" id="waktu-mulai">
                                                <input onkeydown="return false" type="text" name="inputWaktuMulai"
                                                    ...
                                                    value="{{ $peminjamanRuangan->waktuMulai }}">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group clockpicker" id="waktu-selesai">
                                                <input onkeydown="return false" type="text" name="inputWaktuSelesai"
                                                    ...
                                                    value="{{ $peminjamanRuangan->waktuSelesai }}">
                        ...
                        <div class="card">
                            <div class="card-header">Daftar Peminjaman <span id="ruangan">Ruangan
                                    {{ $peminjamanRuangan->ruangan->nama }}</span> <span id="tanggal">Tanggal
                                    {{ $peminjamanRuangan->tanggal }}</span>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
