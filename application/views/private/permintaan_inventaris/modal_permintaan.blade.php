  ...
  <div id="modal-cetak" style="display: none;">
    <form id="form-cetak">
      <div class="card">
        <div class="card-body">
          <div id="error-message-cetak">

          </div>
          <div class="form-group">
            <label>Tanggal</label>
            <input type="text" name="cetak['tanggal']" onkeydown="return false" id="cetak['tanggal']" class="form-control">
          </div>
        ...
        <div class="card-footer submit-area">
          <button class="btn btn-primary btn-block btn-submit-cetak" type="button">Cetak</button>
  ...
  <script>
    ...
    var show_modal = function(id) {
      ...
      if (id) {
        $.ajax({
            url: SITE_URL + 'private/permintaan_inventaris/info/' + id,
            type: 'GET',
            dataType: 'json',
          ...
          .done(function(data) {
            ...
            $("#modal-detail").iziModal('setTitle', 'Detail Permintaan Inventaris');
    ...
    var set_modal_data = function(data) {
      ...
      var el = $("#table-det-permintaan");
      el.empty();
      var noPage = 1;
      $.each(data.det_permintaan_inventaris.reverse(), function(index, val) {
