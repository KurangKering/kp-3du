...
REPLACE INTO `daftar_inventaris` (`id`, `nama`, `stock`, `satuan`, `created_at`, `updated_at`) VALUES
	(3, 'Pena', 24, 'Pcs', '2019-08-02 19:23:47', '2021-09-19 15:39:20'),
	(4, 'Batu', 24, 'Pcs', '2019-08-03 22:38:51', '2021-09-19 22:52:44');
...
-- Dumping data for table kp_edu.det_peminjaman_barang: ~4 rows (approximately)
...
-- Dumping data for table kp_edu.det_pengajuan_inventaris: ~0 rows (approximately)
...
-- Dumping data for table kp_edu.det_permintaan_inventaris: ~0 rows (approximately)
...
-- Dumping data for table kp_edu.det_ruangan: ~2 rows (approximately)
...
-- Dumping data for table kp_edu.isi_disposisi: ~1 rows (approximately)
...
-- Dumping data for table kp_edu.permintaan_inventaris: ~0 rows (approximately)
